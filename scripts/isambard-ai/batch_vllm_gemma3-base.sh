...
./scripts/isambard-ai/serve_qwen_with_tools.sh > serve_qwen_with_tools_out.log 2>&1 &
./scripts/isambard-ai/serve_t0.sh google/gemma-3-4b-it > serve_t0_1_gemma3-out.log 2>&1 &

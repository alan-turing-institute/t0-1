...
#SBATCH --mem 0
#SBATCH --job-name gemma2.5_gpt-oss
#SBATCH --output gemma2.5_gpt-oss.log
...
CUDA_VISIBLE_DEVICES=0,1 ./scripts/isambard-ai/serve_gpt-oss_with_tools.sh > serve_gpt-oss_with_tools_out.log 2>&1 &

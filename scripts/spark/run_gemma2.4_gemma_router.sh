...
t0-1 evaluate-rag /t0-1_local/data/synthetic_queries/5147cd8_gpt-4o_1000_synthetic_queries.jsonl --k 5 --db-choice chroma --llm-provider openai_completion --llm-model-name TomasLaz/t0-2.4-gemma-3-4b-it --budget-forcing --budget-forcing-kwargs '{"max_tokens_thinking": 256, "num_stop_skips": 3}' --extra-body '{"max_tokens": 256}' --prompt-template-path /t0-1_local/templates/rag_evaluation_prompt_deepseek_r1.txt --system-prompt-path /t0-1_local/templates/rag_evaluation_system_prompt_deepseek_r1.txt --output-file /t0-1_local/evaluate-rag-t0-2.4-gemma-router-k5-32B-thinking256-k5-chroma.jsonl --conditions-file /t0-1_local/data/nhs-conditions/v4/qwen_summarised_conditions.jsonl --persist-directory /t0-1_local/v4-summarised-db --local-file-store /t0-1_local/v4-summarised-lfs

...
./scripts/spark/serve_gpt-oss_with_tools.sh > serve_gpt-oss_with_tools_out.log 2>&1 &
...
./scripts/spark/serve_t0.sh TomasLaz/t0-2.5-gemma-3-4b-it 0.2 > serve_t0_gemma2.5_out.log 2>&1 &
# Wait for the REST API to be available

...
: "${DATASET_PATH:="/home/u5gf/tomas.u5gf/u5gf_shared/t0/tomas/t0_data/2k-gpt-oss-120b-traces-k5_qwen_summarised_data_gemma_format"}"
: "${RUN_NAME:="t0-2.4"}"
: "${BLOCK_SIZE:=32768}"
: "${EPOCHS:=5}"
: "${LR:=1e-5}"
...
FORGE_ENV_PATH="/home/u5gf/tomas.u5gf/u5gf_shared/t0/tomas/conda_env/t0_phase3"
SCRIPT_PATH="/home/u5gf/tomas.u5gf/u5gf_shared/t0/tomas/t0-1/train/s1_31a10f2/train/sft.py"
...
source "${FORGE_ENV_PATH}/bin/activate" || eval "$(mamba shell hook --shell bash)" && mamba activate "${FORGE_ENV_PATH}"

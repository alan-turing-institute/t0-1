...
class RAG:
    ...
    def query(self, question: str, thread_id: str = "0") -> str:
        """
        ...
        """
        response = self._query(question=question, thread_id=thread_id)

        return response["messages"][-1].content

    async def aquery(self, question: str, thread_id: str = "0") -> str:
        """
        ...
        str
            The answer generated by the RAG.
        """
        response = await self._aquery(question=question, thread_id=thread_id)

        return response["messages"][-1].content

    async def aquery_with_sources(self, question: str, thread_id: str = "0") -> str:
        """
    ...
    async def aquery_with_context(self, question: str, thread_id: str = "0") -> str:
        """

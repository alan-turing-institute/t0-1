...
- Extract text from website for each condition. 
...
## Tasks for evaluation in sprint 1

Our tasks try to approximate a user-query, corresponding to a
descriptions of the sympoms of an imaginary patient. In each of the
following tasks, the model is to predict one or more conditions
corresponding to a set of symptoms. 
